...
O Sistema Acadêmico é uma aplicação desenvolvida em Python com integração a banco de dados MySQL, criada para simular o gerenciamento de uma instituição de ensino.
